@echo off
REM ============================================================================
REM hercscript Extension Installer for Zed Editor (Windows)
REM ============================================================================
REM This script installs the hercscript extension for Zed Editor on Windows
...
set TARGET_DIR=%ZED_EXT_DIR%\hercscript
...
echo   3. Open any .txt or Hercules script file to see syntax highlighting
echo.
echo To verify installation:
echo   - Open a .txt file in Zed
echo   - Check the language indicator (bottom-right corner)
echo   - It should show "hercscript"
echo.
echo Example files to test:
echo   - %SCRIPT_DIR%\example.txt
echo.
echo ============================================================================
