#!/usr/bin/env bash
#=============================================================================
#= hercscript Extension Installer for Zed Editor
#=============================================================================
...
if [[ "$OSTYPE" == "darwin"* ]]; then
    ...
    echo "For Windows, please use install.bat or follow README.md"
    exit 1
fi
...
print_header() {
    echo -e "${BLUE}"
    echo "============================================================"
    echo "  hercscript Extension Installer for Zed Editor"
    echo "============================================================"
    echo -e "${NC}"
}
...
verify_installation() {
    ...
    local required_files=(
        "extension.toml"
        "languages/hercscript/config.toml"
        "languages/hercscript/highlights.scm"
    )
...
show_next_steps() {
    ...
    echo "  2. Open any .txt or Hercules script file"
    echo "  3. Check the language indicator in bottom-right"
    echo "  4. You should see 'hercscript'"
    echo ""
    ...
    echo "  zed $EXTENSION_DIR/example.txt"
    echo ""
...
uninstall() {
    ...
    print_warning "This will remove the hercscript extension"
...
Install the hercscript extension for Zed Editor.
...
For more information, see: $EXTENSION_DIR/README.md
EOF
}
